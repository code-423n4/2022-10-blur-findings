Using "++i" instead of "i++" might save gas. Some example lines are below:
...
Using "size != 0" instead of "size > 0" might save gas. Because, "size" is a uint it can never be smaller than 0. Case below:
